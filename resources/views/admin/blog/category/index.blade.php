                            ...
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <div class="form-group">
                                        ...
                                        <button class="btn_delete_all btn btn-outline-danger " type="button">
                                            <span><i aria-hidden="true"></i> @lang('delete')</span>
                                        </button>
                                        <button data-status="1" class="btn_status btn btn-outline-success " type="button">
                                            <span><i aria-hidden="true"></i> @lang('activate')</span>
                                        </button>
                                        <button data-status="0" class="btn_status btn btn-outline-warning " type="button">
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('blog.category.update') }}" method="POST" id="form_edit" class=""
                    enctype="multipart/form-data">
                    @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('blog.category.indexTable', app()->getLocale()) }}',
                data: function(d) {
